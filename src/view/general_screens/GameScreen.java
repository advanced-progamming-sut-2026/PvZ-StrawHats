...
public class GameScreen extends BaseScreen {
    ...
    /** Minimal custom widget: fills left-to-right by wavesSpawned/totalWaves, with a tick mark
     *  at each wave boundary so the player can see how far the next wave is. */

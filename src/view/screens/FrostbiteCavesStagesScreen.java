...
public class FrostbiteCavesStagesScreen extends UiScreen {
    ...
    private static final Color TRAIL_COLOR = new Color(0.55f, 0.75f, 0.88f, 0.85f);
    private static final Color UNLOCKED_FILL = new Color(0.33f, 0.62f, 0.82f, 1f);
    private static final Color UNLOCKED_BOSS_FILL = new Color(0.62f, 0.20f, 0.55f, 1f);
    ...
    private void build() {
        ...
        rootTable.add(new Label("Frostbite Caves", skin, "title")).padTop(SPACE_MD).row();
    ...
    private void refreshSelectionBar() {
        ...
        boolean isChapterSelection = selected != null && selected.getSeason().getName().equalsIgnoreCase(CHAPTER_NAME);
    ...
    private class StagePath extends Group {
        ...
        StagePath() {
            ...
            if (count == 0) {
                ...
                empty.setPosition(PATH_WIDTH / 2f - 120f, PATH_HEIGHT / 2f);
                addActor(empty);
            }
        }

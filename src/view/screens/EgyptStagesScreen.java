...
public class EgyptStagesScreen extends UiScreen {
    ...
    private void build() {
        ...
        rootTable.add(new Label("Ancient Egypt", skin, "title")).padTop(SPACE_MD).row();
    ...
    private void refreshSelectionBar() {
        ...
        boolean isEgyptSelection = selected != null && selected.getSeason().getName().equalsIgnoreCase(CHAPTER_NAME);
        if (isEgyptSelection) {
    ...
    private class StagePath extends Group {
        ...
        private com.badlogic.gdx.scenes.scene2d.utils.Drawable nodeCircleDrawable(float size, boolean boss, StageStatus status) {
            Color fill = switch (status) {
                ...
                case UNLOCKED -> boss ? new Color(0.70f, 0.18f, 0.16f, 1f) : new Color(0.80f, 0.60f, 0.20f, 1f);
            };
        ...
        private class TrailActor extends Actor {
            ...
            public void draw(Batch batch, float parentAlpha) {
                batch.setColor(0.72f, 0.58f, 0.30f, 0.85f);
